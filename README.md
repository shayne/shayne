...
- [shayne/derphole](https://github.com/shayne/derphole) (4 weeks ago)
...
- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) (5 weeks ago)
  - Yeet VM image bundles

### Recent releases

- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) ([kernel-linux-7.2.7-yeet-v1](https://github.com/yeetrun/yeet-vm-images/releases/tag/kernel-linux-7.2.7-yeet-v1), 4 days ago)
  - Yeet VM image bundles
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) ([v2.7.0](https://github.com/JuliusBrussee/caveman/releases/tag/v2.7.0), 11 days ago)
  - 🪨 why use many token when few token do trick. Viral skill + proxy for coding agents that cuts 65% of tokens by talking like a caveman.
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.11.12](https://github.com/yeetrun/yeet/releases/tag/v0.11.12), 2 weeks ago)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
- [shayne/derphole](https://github.com/shayne/derphole) ([v0.18.2](https://github.com/shayne/derphole/releases/tag/v0.18.2), 5 weeks ago)
  - Move files, open TCP tunnels, and share a terminal when a VPN is too much state for one job. DERP gets peers connected; tokens keep access scoped.
- [shayne/RPi-Plane-Radar](https://github.com/shayne/RPi-Plane-Radar) ([v0.2.1](https://github.com/shayne/RPi-Plane-Radar/releases/tag/v0.2.1), 6 weeks ago)
  - A Raspberry Pi Zero 2 W ADS-B radar for the HyperPixel 2.1 Round

### Recent starred projects

- [webadderallorg/Recordly](https://github.com/webadderallorg/Recordly) (31344)
...
- [ZimengXiong/tinyTouch](https://github.com/ZimengXiong/tinyTouch) (1572)
  - authenticate, sudo, login with your fingerprint wire(less)ly without having to spend $149 at the cost of some security
- [mattpocock/skills](https://github.com/mattpocock/skills) (270026)
  - Skills for Real Engineers. Straight from my .agents directory.
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (85541)
