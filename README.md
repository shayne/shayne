...
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.9.7](https://github.com/yeetrun/yeet/releases/tag/v0.9.7), 6 days ago)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
- [shayne/derphole](https://github.com/shayne/derphole) ([v0.16.3](https://github.com/shayne/derphole/releases/tag/v0.16.3), 9 days ago)
  - Move files, open TCP tunnels, and share a terminal when a VPN is too much state for one job. DERP gets peers connected; tokens keep access scoped.
...
- [mattpocock/skills](https://github.com/mattpocock/skills) (173905)
  - Skills for Real Engineers. Straight from my .claude directory.
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (57153)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (255911)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (84561)
