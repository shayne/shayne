...
- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) ([nixos-26.05-amd64-latest](https://github.com/yeetrun/yeet-vm-images/releases/tag/nixos-26.05-amd64-latest), today)
  - Yeet VM image bundles
- [shayne/derphole](https://github.com/shayne/derphole) ([v0.17.0](https://github.com/shayne/derphole/releases/tag/v0.17.0), 2 days ago)
  - Move files, open TCP tunnels, and share a terminal when a VPN is too much state for one job. DERP gets peers connected; tokens keep access scoped.
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.9.7](https://github.com/yeetrun/yeet/releases/tag/v0.9.7), 9 days ago)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
...
- [mattpocock/skills](https://github.com/mattpocock/skills) (177233)
  - Skills for Real Engineers. Straight from my .agents directory.
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (57999)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (257466)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (85971)
