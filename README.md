...
- [shayne/derphole](https://github.com/shayne/derphole) ([v0.16.0](https://github.com/shayne/derphole/releases/tag/v0.16.0), today)
  - DERP-powered CLI suite for file transfer, TCP tunnels, and approved terminal sharing with encrypted relay fallback and direct UDP upgrades.
...
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (49702)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (245317)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (72702)
