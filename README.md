...
- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) ([kernel-linux-7.2.5-yeet-v1](https://github.com/yeetrun/yeet-vm-images/releases/tag/kernel-linux-7.2.5-yeet-v1), 1 day ago)
  - Yeet VM image bundles
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.11.12](https://github.com/yeetrun/yeet/releases/tag/v0.11.12), 5 days ago)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) ([bin-v1.1.6](https://github.com/JuliusBrussee/caveman/releases/tag/bin-v1.1.6), 9 days ago)
...
- [webadderallorg/Recordly](https://github.com/webadderallorg/Recordly) (27717)
  - Create polished demo videos without editing skills. Mac/Windows/Linux
- [jeb5/YouTube-Subscriptions-RSS](https://github.com/jeb5/YouTube-Subscriptions-RSS) (421)
  - Generate an OPML file of RSS feeds for your YouTube subscriptions
- [ZimengXiong/tinyTouch](https://github.com/ZimengXiong/tinyTouch) (1554)
  - authenticate, sudo, login with your fingerprint wire(less)ly without having to spend $149 at the cost of some security
- [mattpocock/skills](https://github.com/mattpocock/skills) (260518)
  - Skills for Real Engineers. Straight from my .agents directory.
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (79779)
