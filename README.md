...
- [shayne/nixos-config](https://github.com/shayne/nixos-config) (13 days ago)
...
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) ([v2.7.0](https://github.com/JuliusBrussee/caveman/releases/tag/v2.7.0), 2 days ago)
  - 🪨 why use many token when few token do trick. Viral skill + proxy for coding agents that cuts 65% of tokens by talking like a caveman.
- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) ([kernel-linux-7.2.6-yeet-v1](https://github.com/yeetrun/yeet-vm-images/releases/tag/kernel-linux-7.2.6-yeet-v1), 3 days ago)
  - Yeet VM image bundles
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.11.12](https://github.com/yeetrun/yeet/releases/tag/v0.11.12), 10 days ago)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
...
- [webadderallorg/Recordly](https://github.com/webadderallorg/Recordly) (29475)
...
- [ZimengXiong/tinyTouch](https://github.com/ZimengXiong/tinyTouch) (1561)
  - authenticate, sudo, login with your fingerprint wire(less)ly without having to spend $149 at the cost of some security
- [mattpocock/skills](https://github.com/mattpocock/skills) (264380)
  - Skills for Real Engineers. Straight from my .agents directory.
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (82770)
