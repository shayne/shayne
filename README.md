...
- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) ([nixos-26.05-amd64-latest](https://github.com/yeetrun/yeet-vm-images/releases/tag/nixos-26.05-amd64-latest), 2 days ago)
  - Yeet VM image bundles
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.9.2](https://github.com/yeetrun/yeet/releases/tag/v0.9.2), 2 days ago)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
...
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (52530)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (248521)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (76629)
...
- [FelixKratz/SketchyBar](https://github.com/FelixKratz/SketchyBar) (11995)
