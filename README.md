...
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.9.0](https://github.com/yeetrun/yeet/releases/tag/v0.9.0), today)
  - Homelab Service Manager for Docker, Compose, and systemd
...
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (49823)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (245503)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (72977)
