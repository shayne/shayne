...
- [yeetrun/yeet-vm-images](https://github.com/yeetrun/yeet-vm-images) ([firecracker-v1.16.1-yeet-v1-canary-29893998019](https://github.com/yeetrun/yeet-vm-images/releases/tag/firecracker-v1.16.1-yeet-v1-canary-29893998019), today)
  - Yeet VM image bundles
...
- [mattpocock/skills](https://github.com/mattpocock/skills) (181517)
  - Skills for Real Engineers. Straight from my .agents directory.
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (59472)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (259193)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (87636)
