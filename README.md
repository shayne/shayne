...
- [shayne/cmtr](https://github.com/shayne/cmtr) (9 days ago)
  - cmtr writes accurate git commit messages from your staged diff and repo history using Codex and OpenAI.

### Recent releases

- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.6.14](https://github.com/yeetrun/yeet/releases/tag/v0.6.14), today)
  - Homelab Service Manager for Docker, Compose, and systemd
...
- [MisterTea/EternalTerminal](https://github.com/MisterTea/EternalTerminal) (3714)
  - Re-Connectable secure remote shell
- [earthtojake/text-to-cad](https://github.com/earthtojake/text-to-cad) (5834)
