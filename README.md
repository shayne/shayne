...
- [yeetrun/yeet](https://github.com/yeetrun/yeet) ([v0.9.5](https://github.com/yeetrun/yeet/releases/tag/v0.9.5), today)
  - Run containers, VMs, binaries, and cron jobs on Linux hosts you control. No tiny cloud required.
...
- [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (53240)
  - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
- [obra/superpowers](https://github.com/obra/superpowers) (249801)
  - An agentic skills framework & software development methodology that works.
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) (78019)
